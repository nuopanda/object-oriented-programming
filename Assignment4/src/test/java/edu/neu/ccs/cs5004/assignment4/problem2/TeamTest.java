...
public class TeamTest {
  ...
  public void setUp() throws Exception {
    ...
    this.league = new League("Football Family", 1, 4, 10);
    this.team1 = new AmericanFootballTeam("Seattle", league);
    this.team2 = new AmericanFootballTeam("Boston", league);
  }
  ...
  public void testPlayGame() throws Exception {
    ...
    assertTrue(1 == this.team1.getRecord().getTieNum());
